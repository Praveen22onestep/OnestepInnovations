...
export const metadata = {
    ...
    description: "Expert AI Process Automation, IoT Solutions, and Strategic Management services for SME and enterprise manufacturers across Australia. Proven results.",
};
