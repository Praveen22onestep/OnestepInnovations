            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-0 right-0 sm:bottom-6 sm:right-6 z-50 w-full sm:w-[380px] h-[100dvh] sm:h-[550px] bg-card-bg border border-card-border sm:rounded-2xl shadow-2xl flex flex-col overflow-hidden"
                    >
                        {/* Header */}
