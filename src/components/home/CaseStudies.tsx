            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {caseStudies.map((study, index) => (
                        ...
                        >
                            <div className={`p-6 border-b border-card-border ${study.color === "deep-amber" ? "bg-gradient-to-r from-deep-amber/10 to-transparent" : "bg-gradient-to-r from-neon-cyan/10 to-transparent"}`}>
